...
export function Vimeo() {
  return (
    ...
    >
      <path
        d="M17.5 3.4C17.5 3.4 17.3 2.1 16.6 1.7C15.9 1.2 14.6 1.5 14.6 1.5C14.6 1.5 13.5 1.7 12.7 3C12.1 4 11.4 5.5 11 6.4C10.4 7.7 10.1 8.4 9.6 9.2C8.8 10.5 7.9 11.2 7.4 10.9C6.9 10.6 7 9.4 7 9.4C7 9.4 7.2 8.3 7.6 7.3C8.2 6.1 9.4 3.6 9.4 3.6C9.4 3.6 9.6 3.2 9.3 3C9 2.8 8.7 3 8.3 3.2C7.5 3.6 6.5 4.3 5.6 5.4C4.6 6.6 3.9 8.3 3.9 8.3C3.9 8.3 3.1 10.2 4.1 11.5C5.1 12.8 7 13 8.2 12.7C9.4 12.3 10.6 11.4 11.6 10C13.1 7.9 14.3 5.1 14.3 5.1C14.3 5.1 14.9 3.8 15.5 4C16.1 4.2 16.3 5.3 16.3 5.3L17.5 3.4Z"
        fill="currentColor"
      />
    </svg>
  );
