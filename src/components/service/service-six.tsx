...
// images
import ser_img_1 from "@/assets/img/inner-service/service/service-1.jpeg";
import ser_img_2 from "@/assets/img/inner-service/service/service-2.jpg";
import ser_img_3 from "@/assets/img/inner-service/service/service-3.jpeg";
...
export default function ServiceSix() {
  return (
    <div className="sv-service-area mb-20 md:mb-2">
      <div className="container container-1630">
        {service_data.map((item) => (
          <div key={item.id} className="sv-service-item"  style={{ marginBottom: "25px" }}>
