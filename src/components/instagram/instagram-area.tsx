...
import inst_8 from "@/assets/img/home-02/instagram/insta-1.jpg"; // Assuming this is the correct path
        ...
        {instagram_images.map((item) => (
          ...
          >
            <Image
              ...
              layout="responsive" // optional: adjust based on how you want to handle image sizes
              width={600} // specify the width
              height={400} // specify the height
              objectFit="cover" // optional: ensure images cover the space without distortion
            />
          </div>
        ))}
