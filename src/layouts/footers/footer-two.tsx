          ...
          <div className="row">
              ...
              <div className="tp-footer-2-widget footer-col-2-2">
                <div className="tp-footer-2-widget-menu">
                  ...
                  <ul>
                    ...
                    <li> <a href="/portfolio-masonry">Portfolio</a></li>
            ...
            <div className="col-xl-3 col-lg-5 col-md-6 mb-50">
              <div className="tp-footer-2-widget footer-col-2-3">
                ...
                <div className="tp-footer-2-contact-item">
                  <span>
                    <a href="mailto:info@funkaar.co">E: info@funkaar.co</a>
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="row align-items-center">
            ...
            <div className="col-xl-8 col-lg-7">
              <div className="tp-copyright-2-social text-center text-lg-end">
                <a className="mb-10" href="https://www.youtube.com/@funkaar_co">Youtube</a>
                <a className="mb-10" href="https://vimeo.com/funkaar">Vimeo</a>
                <a className="mb-10" href="https://www.linkedin.com/company/funkaarco">Linkedin</a>
                <a className="mb-10" href="https://www.instagram.com/funkaar_co">Instagram</a>
              </div>
            </div>
          </div>
        </div>
